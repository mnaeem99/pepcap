...
import com.pepcap.inventorymanagement.domain.core.products.*;
...
public class ProductsAppServiceTest {
	...
	@Test
	public void ParseinventoryTransactionsJoinColumn_KeysStringIsNotEmptyAndKeyValuePairDoesNotExist_ReturnNull()
	{
	    Map<String,String> joinColumnMap = new HashMap<String,String>();
		String keyString= "15";
		joinColumnMap.put("productId", keyString);
		Assertions.assertThat(_appService.parseInventoryTransactionsJoinColumn(keyString)).isEqualTo(joinColumnMap);
	}
}
