...
public class ProductsControllerTestExtended extends DatabaseContainerConfig {
	...
	public void setup() {
		...
		final ProductsControllerExtended productsController = new ProductsControllerExtended(productsAppServiceExtended, categoriesAppServiceExtended, inventoryTransactionsAppServiceExtended,
	logHelper,env);
