...
import com.pepcap.inventorymanagement.application.extended.suppliers.SuppliersAppServiceExtended;
...
public class SuppliersControllerTestExtended extends DatabaseContainerConfig {
	...
	protected ISuppliersRepositoryExtended suppliers_repositoryExtended;
	...
	public void setup() {
		...
		final SuppliersControllerExtended suppliersController = new SuppliersControllerExtended(suppliersAppServiceExtended,
	logHelper,env);
