...
describe('BaseDetailsComponent', () => {
  ...
  it('should update entry', async () => {
    ...
    expect(component.dataService.update).toHaveBeenCalledWith(data, component.idParam, undefined);
  });
  ...
  it('should open child details in case of onetomany association', async () => {
    ...
    expect(router.navigate).toHaveBeenCalledWith(['/'+component.associations[0].table?.toLowerCase()], { queryParams: { dummyId: 1 } });
  });
