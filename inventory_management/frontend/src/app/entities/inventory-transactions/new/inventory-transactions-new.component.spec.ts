...
import { IInventoryTransactions,InventoryTransactionsService, InventoryTransactionsNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('InventoryTransactionsNewComponent', () => {
  let component: InventoryTransactionsNewComponent;
  let fixture: ComponentFixture<InventoryTransactionsNewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(InventoryTransactionsNewComponent);
