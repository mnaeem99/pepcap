...
import { IInventoryTransactions, InventoryTransactionsService, InventoryTransactionsDetailsComponent, InventoryTransactionsListComponent } from '../';
...
describe('InventoryTransactionsDetailsComponent', () => {
  let component: InventoryTransactionsDetailsComponent;
  let fixture: ComponentFixture<InventoryTransactionsDetailsComponent>;
  let el: HTMLElement;
  ...
  let data:IInventoryTransactions = {
    createdAt: d,
    createdAtTime: t,
    id: 1,
    quantity: 1,
  ...
  describe('Unit Tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(InventoryTransactionsDetailsComponent);
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'inventorytransactions', component: InventoryTransactionsDetailsComponent },
            { path: 'inventorytransactions/:id', component: InventoryTransactionsListComponent }
          ])
        ],
        providers: [
          InventoryTransactionsService
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/inventorytransactions');
