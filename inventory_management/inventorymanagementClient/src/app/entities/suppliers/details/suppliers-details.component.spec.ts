...
import { ISuppliers, SuppliersService, SuppliersDetailsComponent, SuppliersListComponent } from '../';
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'suppliers', component: SuppliersDetailsComponent },
            { path: 'suppliers/:id', component: SuppliersListComponent }
          ])
        ],
        providers: [
          SuppliersService
