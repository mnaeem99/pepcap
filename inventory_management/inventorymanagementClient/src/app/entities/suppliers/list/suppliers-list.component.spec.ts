...
import { ISuppliers, SuppliersService, SuppliersDetailsComponent, SuppliersListComponent,
	SuppliersNewComponent } from '../';
...
describe('SuppliersListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/suppliers/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
