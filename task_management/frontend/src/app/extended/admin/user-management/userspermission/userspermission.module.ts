...
import { UserspermissionExtendedService, UserspermissionDetailsExtendedComponent, UserspermissionListExtendedComponent, UserspermissionNewExtendedComponent } from './';
...
const entities = [
    UserspermissionDetailsExtendedComponent, UserspermissionListExtendedComponent, UserspermissionNewExtendedComponent 
  ]
@NgModule({
