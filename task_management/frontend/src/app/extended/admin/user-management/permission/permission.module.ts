...
import { PermissionExtendedService, PermissionDetailsExtendedComponent, PermissionListExtendedComponent, PermissionNewExtendedComponent } from './';
...
const entities = [
    PermissionDetailsExtendedComponent, PermissionListExtendedComponent, PermissionNewExtendedComponent 
  ]
@NgModule({
