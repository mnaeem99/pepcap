...
import { RoleExtendedService, RoleDetailsExtendedComponent, RoleListExtendedComponent, RoleNewExtendedComponent } from './';
...
const entities = [
    RoleDetailsExtendedComponent, RoleListExtendedComponent, RoleNewExtendedComponent 
  ]
@NgModule({
