...
import { IProjects, ProjectsService, ProjectsDetailsComponent, ProjectsListComponent,
	ProjectsNewComponent } from '../';
...
describe('ProjectsListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/projects/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
