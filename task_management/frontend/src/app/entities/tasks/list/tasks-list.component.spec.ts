...
import { ITasks, TasksService, TasksDetailsComponent, TasksListComponent,
	TasksNewComponent } from '../';
...
describe('TasksListComponent', () => {
  ...
  let constData:ITasks[] = [
    ...
    {   
      ...
      status: 'status2',
      projectId: 2,
      projectsDescriptiveField: 2,
      assigneeId: 2,
      usersDescriptiveField: 2,
    },
  ];
  let data: ITasks[] = [... constData];
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/tasks/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
