...
import { ITimesheets,TimesheetsService, TimesheetsNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('TimesheetsNewComponent', () => {
  let component: TimesheetsNewComponent;
  let fixture: ComponentFixture<TimesheetsNewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(TimesheetsNewComponent);
