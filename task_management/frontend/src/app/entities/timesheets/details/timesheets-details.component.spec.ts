...
import { ITimesheets, TimesheetsService, TimesheetsDetailsComponent, TimesheetsListComponent } from '../';
...
describe('TimesheetsDetailsComponent', () => {
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'timesheets', component: TimesheetsDetailsComponent },
            { path: 'timesheets/:id', component: TimesheetsListComponent }
          ])
        ],
        providers: [
          TimesheetsService
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/timesheets');
