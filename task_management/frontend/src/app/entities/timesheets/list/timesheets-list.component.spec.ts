...
import { ITimesheets, TimesheetsService, TimesheetsDetailsComponent, TimesheetsListComponent,
	TimesheetsNewComponent } from '../';
...
describe('TimesheetsListComponent', () => {
  ...
  let constData:ITimesheets[] = [
    ...
    {   
      ...
      id: 2,
      taskId: 2,
      tasksDescriptiveField: 2,
      userId: 2,
      usersDescriptiveField: 2,
    },
  ];
  let data: ITimesheets[] = [... constData];
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'timesheets/:id', component: TimesheetsDetailsComponent }
          ])
        ],
        providers: [
          TimesheetsService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/timesheets/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
