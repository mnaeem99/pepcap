...
import com.pepcap.taskmanagement.application.extended.authorization.usersrole.UsersroleAppServiceExtended;
...
import com.pepcap.taskmanagement.application.extended.authorization.role.RoleAppServiceExtended;    
...
public class UsersroleControllerTestExtended extends DatabaseContainerConfig {
	...
	public void setup() {
		...
		final UsersroleControllerExtended usersroleController = new UsersroleControllerExtended(usersroleAppServiceExtended, roleAppServiceExtended, usersAppServiceExtended,
