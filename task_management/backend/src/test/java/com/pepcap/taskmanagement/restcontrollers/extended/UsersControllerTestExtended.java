...
public class UsersControllerTestExtended extends DatabaseContainerConfig {
	...
	public void setup() {
		...
		final UsersControllerExtended usersController = new UsersControllerExtended(usersAppServiceExtended, tasksAppServiceExtended, timesheetsAppServiceExtended, userspermissionAppServiceExtended, usersroleAppServiceExtended,
