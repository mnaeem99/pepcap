...
import com.pepcap.taskmanagement.application.core.authorization.permission.IPermissionAppService;
import com.pepcap.taskmanagement.application.core.authorization.permission.dto.*;
import com.pepcap.taskmanagement.application.core.authorization.rolepermission.IRolepermissionAppService;
import com.pepcap.taskmanagement.application.core.authorization.rolepermission.dto.FindRolepermissionByIdOutput;
import com.pepcap.taskmanagement.application.core.authorization.userspermission.IUserspermissionAppService;
import com.pepcap.taskmanagement.application.core.authorization.userspermission.dto.FindUserspermissionByIdOutput;
import java.util.*;
import java.time.*;
...
public class PermissionController {
	...
	public ResponseEntity<List<FindPermissionByIdOutput>> find(@RequestParam(value="search", required=false) String search, @RequestParam(value = "offset", required=false) String offset, @RequestParam(value = "limit", required=false) String limit, Sort sort) throws EntityNotFoundException, MalformedURLException {
