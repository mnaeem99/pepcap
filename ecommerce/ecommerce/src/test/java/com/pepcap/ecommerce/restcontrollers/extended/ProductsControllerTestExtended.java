...
import com.pepcap.ecommerce.domain.extended.products.IProductsRepositoryExtended;
import com.pepcap.ecommerce.domain.core.products.Products;
import com.pepcap.ecommerce.application.extended.categories.CategoriesAppServiceExtended;    
...
public class ProductsControllerTestExtended extends DatabaseContainerConfig {
	...
	public void setup() {
		...
		final ProductsControllerExtended productsController = new ProductsControllerExtended(productsAppServiceExtended, categoriesAppServiceExtended, orderItemsAppServiceExtended,
	logHelper,env);
