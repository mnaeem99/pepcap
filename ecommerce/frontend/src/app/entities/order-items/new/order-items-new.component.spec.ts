...
import { IOrderItems,OrderItemsService, OrderItemsNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('OrderItemsNewComponent', () => {
  let component: OrderItemsNewComponent;
  let fixture: ComponentFixture<OrderItemsNewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(OrderItemsNewComponent);
