...
import { UsersExtendedService, UsersDetailsExtendedComponent, UsersListExtendedComponent, UsersNewExtendedComponent } from './';
...
const entities = [
    UsersDetailsExtendedComponent, UsersListExtendedComponent, UsersNewExtendedComponent 
  ]
@NgModule({
