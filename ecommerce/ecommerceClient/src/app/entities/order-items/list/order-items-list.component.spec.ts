...
import { IOrderItems, OrderItemsService, OrderItemsDetailsComponent, OrderItemsListComponent,
	OrderItemsNewComponent } from '../';
...
describe('OrderItemsListComponent', () => {
  ...
  let constData:IOrderItems[] = [
    ...
    {   
      ...
      quantity: 2,
      orderId: 2,
      ordersDescriptiveField: 2,
      productId: 2,
      productsDescriptiveField: 2,
    },
  ];
  let data: IOrderItems[] = [... constData];
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'orderitems', component: OrderItemsListComponent },
            { path: 'orderitems/:id', component: OrderItemsDetailsComponent }
          ])
        ],
        providers: [
          OrderItemsService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/orderitems/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
