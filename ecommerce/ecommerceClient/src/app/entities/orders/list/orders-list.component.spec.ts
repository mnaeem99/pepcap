...
import { IOrders, OrdersService, OrdersDetailsComponent, OrdersListComponent,
	OrdersNewComponent } from '../';
...
describe('OrdersListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/orders/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
