...
import { ICategories, CategoriesService, CategoriesDetailsComponent, CategoriesListComponent,
	CategoriesNewComponent } from '../';
...
describe('CategoriesListComponent', () => {
  ...
  let data: ICategories[] = [... constData];
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/categories/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
