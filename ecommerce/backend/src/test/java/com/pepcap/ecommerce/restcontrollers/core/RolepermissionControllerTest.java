...
import com.pepcap.ecommerce.domain.core.authorization.rolepermission.IRolepermissionRepository;
import com.pepcap.ecommerce.domain.core.authorization.rolepermission.Rolepermission;

import com.pepcap.ecommerce.domain.core.authorization.permission.IPermissionRepository;
import com.pepcap.ecommerce.domain.core.authorization.permission.Permission;
import com.pepcap.ecommerce.domain.core.authorization.role.IRoleRepository;
...
public class RolepermissionControllerTest extends DatabaseContainerConfig{
	...
	public static void cleanup() {
		...
		em.createNativeQuery("truncate table e_commerce.rolepermission CASCADE").executeUpdate();
		em.createNativeQuery("truncate table e_commerce.permission CASCADE").executeUpdate();
		em.createNativeQuery("truncate table e_commerce.role CASCADE").executeUpdate();
