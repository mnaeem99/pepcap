...
import { RolepermissionExtendedService, RolepermissionDetailsExtendedComponent, RolepermissionListExtendedComponent, RolepermissionNewExtendedComponent } from './';
...
const entities = [
    RolepermissionDetailsExtendedComponent, RolepermissionListExtendedComponent, RolepermissionNewExtendedComponent 
  ]
@NgModule({
