...
import { IProducts, ProductsService, ProductsDetailsComponent, ProductsListComponent,
	ProductsNewComponent } from '../';
...
describe('ProductsListComponent', () => {
  ...
  let constData:IProducts[] = [
    {   
      ...
      updatedAt: d,
      categoryId: 1,
      categoriesDescriptiveField: 'name1',
    },
    {   
      createdAt: d,
      ...
      updatedAt: d,
      categoryId: 2,
      categoriesDescriptiveField: 'name2',
    },
  ];
  let data: IProducts[] = [... constData];
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/products/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
