...
import { IUsersrole,UsersroleService, UsersroleNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('UsersroleNewComponent', () => {
  let component: UsersroleNewComponent;
  let fixture: ComponentFixture<UsersroleNewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(UsersroleNewComponent);
