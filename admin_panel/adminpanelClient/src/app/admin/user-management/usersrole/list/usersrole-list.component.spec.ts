...
import { IUsersrole, UsersroleService, UsersroleDetailsComponent, UsersroleListComponent,
	UsersroleNewComponent } from '../';
...
describe('UsersroleListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/usersrole/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
