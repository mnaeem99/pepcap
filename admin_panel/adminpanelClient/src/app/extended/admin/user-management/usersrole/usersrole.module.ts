...
import { UsersroleExtendedService, UsersroleDetailsExtendedComponent, UsersroleListExtendedComponent, UsersroleNewExtendedComponent } from './';
...
const entities = [
    UsersroleDetailsExtendedComponent, UsersroleListExtendedComponent, UsersroleNewExtendedComponent 
  ]
@NgModule({
