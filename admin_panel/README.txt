...
3. Login to the Application using the instructions provided on the following page: https://dash.readme.com/project/getpepcap/v1.0/docs/generated-app-login