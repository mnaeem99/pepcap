...
import com.pepcap.adminpanel.domain.core.authorization.rolepermission.IRolepermissionRepository;
import com.pepcap.adminpanel.domain.core.authorization.rolepermission.Rolepermission;

import com.pepcap.adminpanel.domain.core.authorization.permission.IPermissionRepository;
...
public class RolepermissionControllerTest extends DatabaseContainerConfig{
	...
	public static void cleanup() {
		...
		em.createNativeQuery("truncate table admin_panel.rolepermission CASCADE").executeUpdate();
		em.createNativeQuery("truncate table admin_panel.permission CASCADE").executeUpdate();
